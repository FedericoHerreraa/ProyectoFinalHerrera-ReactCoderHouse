...
const Profile = () => {
    ...
    return (
        <div className={stylesProfile.fondo}>
            <div>
                <nav className={stylesProfile.navProfile}>
                    <h2>Perfil</h2>
            ...
            <div className={stylesProfile.container}>
                <div className={stylesProfile.subContainer}>
                    <div className={stylesProfile.information}>
                        <div>
                        ...
                        <div>
                            <label className={stylesProfile.email}><b>Email:</b></label>    
                            <p className={stylesProfile.user}>{user.email}</p>
                        </div>
                    </div>
