...
const Login = () => {
    ...
    return (
        <div className={stylesLogin.container}>
            <div className={stylesLogin.returnHome}>
            ...
            <div className={stylesLogin.containerForm}>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={stylesLogin.linkContainer}>
                        <Link className={stylesLogin.link} to={'/register'}>Todavia no tienes una cuenta? Registrate!</Link>
                    </div>
